...
/**
 * Interfaces with magnetic angular encoders, like the ones we used in the 2014
 * season.
 *
 */
public class MagneticPotentiometerEncoder implements IDistanceEncoder {
     ...
     * have been estimated to high accuracy from extensive tests. Unless need be, do
