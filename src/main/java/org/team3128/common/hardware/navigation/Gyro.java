...
/**
 * Interface to define a gyro sensor, which has minimal methods that allow
 * for the setting and retrieval of yaw.
 * 
...
public interface Gyro {
    /**
     * Gets the current yaw of the robot, with counterclockwise as
     * positive. The function is continuous, so it ranges from negative
    ...
    /**
     * Gives the gyro reading an offset such that the current position
     * is read as whatever desired angle.
     * 
