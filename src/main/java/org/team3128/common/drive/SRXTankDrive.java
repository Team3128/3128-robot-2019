...
private SRXTankDrive(TalonSRX leftMotors, TalonSRX rightMotors, double wheelCircumfrence, double wheelBase, int robotMaxSpeed, SRXInvertCallback driveInverts)
{
	...
	*/
	...
	public class CmdPleaseWorkTurn extends Command {
		...
		public CmdPleaseWorkTurn(Gyro gyro, double angle, double radius, Direction direction, double power, PIDConstants innerPID, PIDConstants outerPID, int timeoutMs) {
			super(timeoutMs / 1000.0);
