...
public class HolonomicDrive {
	...
	public HolonomicDrive(MotorGroup driveLeftFront, MotorGroup driveLeftBack, MotorGroup driveRightFront,
			MotorGroup driveRightBack, ListenerManager listenerManager) {
	...
	public void steer(double joyX, double joyY, double joyTurn, double throttle) {
		...
		Log.debug("HolonomicDrive", String.format("joyY: %f, joyTurn: %f, spdLB: %f, spdRF: %f, spdLF %f, spdRB: %f",
				joyY, joyTurn, _spdLB, _spdRF, _spdLF, _spdRB));
