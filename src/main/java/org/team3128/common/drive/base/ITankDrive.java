...
/**
 * Interface describing the teleop-control functions of a TankDrive Used so that
 * autonomous programs can accept both TankDrive and SRXTankDrive for movement
 * 
 * @author Jamie
 *
 */
public interface ITankDrive {
	 ...
	 * 
	 * Range: [0, 360) 0 degrees is straight ahead, 90 degrees is left.
	 * 
	 * @return
	 */
