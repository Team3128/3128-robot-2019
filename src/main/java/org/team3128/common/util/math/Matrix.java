...
public class Matrix<R extends Num, C extends Num> {
  ...
  /**
   * If a vector then a square matrix is returned if a matrix then a vector of
   * diagonal elements is returned.
   *
   * @return Diagonal elements inside a vector or a square matrix with the same
   *         diagonal elements.
   */
   ...
   *
   * <p>
   * As matrix multiplication is only defined if the number of columns in the
   * first matrix matches the number of rows in the second, this operation will
   * fail to compile under any other circumstances.
   *
   * @param other The other matrix to multiply by.
   * @param <C2>  The number of columns in the second matrix.
   * @return The result of the matrix multiplication between this and the given
   *         matrix.
   */
  ...
  /**
   * <p>
   * Returns a matrix which is the result of an element by element multiplication
   * of 'this' and 'b'. c<sub>i,j</sub> = a<sub>i,j</sub>*b<sub>i,j</sub>
   * </p>
   *
   ...
   * @throws org.ejml.data.SingularMatrixException If this matrix is
   *                                               non-invertable.
   */
  ...
  /**
   * Returns a matrix which is the result of an element by element power of 'this'
   * and 'b': c<sub>i,j</sub> = a<sub>i,j</sub> ^ b.
   *
   * @param b Scalar
  ...
  /**
   * Constructs a new matrix with the given storage. Caller should make sure that
   * the provided generic bounds match the shape of the provided matrix
   *
