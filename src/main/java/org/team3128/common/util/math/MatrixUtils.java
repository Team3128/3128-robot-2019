...
public final class MatrixUtils {
  ...
  /**
   * Entrypoint to the MatBuilder class for creation of custom matrices with the
   * given dimensions and contents.
   *
  ...
  /**
   * Entrypoint to the VecBuilder class for creation of custom vectors with the
   * given size and contents.
   *
