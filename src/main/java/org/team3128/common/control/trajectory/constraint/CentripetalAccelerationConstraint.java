...
public class CentripetalAccelerationConstraint implements TrajectoryConstraint {
   ...
   *
   * @param maxCentripetalAccelerationMetersPerSecondSq The max centripetal
   *                                                    acceleration.
   */
  ...
  public double getMaxVelocityMetersPerSecond(Pose2D poseMeters, double curvatureRadPerMeter,
    ...
    return Math.sqrt(m_maxCentripetalAccelerationMetersPerSecondSq / Math.abs(curvatureRadPerMeter));
  }
