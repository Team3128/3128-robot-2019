...
public interface Interpolable<T> {
	 ...
	 *
	 * @param other      Value of Interpolable that corresponds to 1 for percentage
	 * @param percentage Percentage to interpolate. A value of 1 will return other
	 *                   and 0 will return this Interpolable
