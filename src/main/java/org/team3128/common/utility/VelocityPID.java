...
public class VelocityPID {
	...
	/**
	 * Reset the internal sum of the error. This is a good thing to do if the robot
	 * has been sitting for some time and building up error.
	 */
	...
	public void update(double currentVelocity) {
		...
		storedOutput = (pidConstants.kP * error) + (pidConstants.kI * errorSum) + (pidConstants.kD * errorDerivative)
				+ storedOutput;
	 ...
	 * 
	 *         This function does not do any calculating, you have to call update()
	 *         first
	 */
