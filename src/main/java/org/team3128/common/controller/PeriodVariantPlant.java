...
import org.team3128.common.util.math.SimpleMatrixUtils;
...
public class PeriodVariantPlant<States extends Num, Inputs extends Num, Outputs extends Num> {
   ...
   * @param nominalSamplePeriod The nominal period at which the control loop will
   *                            run.
   */
  public PeriodVariantPlant(PeriodVariantPlantCoeffs<States, Inputs, Outputs> plantCoeffs, double nominalSamplePeriod) {
  ...
  /**
   * Constructs a plant with the given coefficients and a nominal sample period of
   * 0.005s
   *
