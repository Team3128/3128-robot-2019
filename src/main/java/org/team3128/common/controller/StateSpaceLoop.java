...
public class StateSpaceLoop<States extends Num, Inputs extends Num, Outputs extends Num> {
  ...
  /**
   * A convenience constructor for constructing a state-space loop with the given
   * plant, controller, and observer coefficients.
   *
  ...
  public StateSpaceLoop(StateSpacePlant<States, Inputs, Outputs> plant,
      StateSpaceController<States, Inputs, Outputs> controller, StateSpaceObserver<States, Inputs, Outputs> observer) {
