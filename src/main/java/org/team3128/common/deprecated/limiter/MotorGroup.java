...
/**
 * MotorGroup is the class used in this code to represent a motor or several
 * linked ones. It can operate with several different varieties of motor logic
 * to control its speed, or none at all.
 */
public class MotorGroup {
    ...
    /**
     * Reset the speed control. This may or may not do anything, depending on which
    ...
    /**
     * Set a speed scalar from 0 to 1 which will be applied to all motor powers set,
     ...
     * If null is passed, no speed control will be set and the target value will be
     * used as the motor power.
     * 
     * @param motorLogic
     */
    ...
    /**
     * Start the speed control and set the control target. If the control is already
     * running, all this does is clear and set the target of the control.
     * 
     * @param target
     */
