package org.team3128.common.deprecated.limiter;
...
/**
 * MotorLogic is an abstract superclass for classes that define the behavior of
 * a motor. This class does all of the boilerplate, like getters and setters,
 * while the subclass implements the actual math and logic.
 * 
...
public abstract class MotorLogic {
    ...
    /**
     * Set the desired value for the motor controller to target. Exactly what units
     * this is in depends on the controller.
     * 
     * @param val
     */
    ...
    /**
     * Reset any permanent state of the speed controller as well as the speed
     * target.
     */
     ...
     * 
     * @param dt the time im milliseconds since the last update. Actually working
     *           since 4-6-2015!
     * @return
     */
    ...
    /**
     * Return true if the motor control is finished and the thread should stop
     * running.
     */
    ...
    /**
     * Start the controller thread if it is stopped, which it is when you construct
     * the object.
     */
    public void start() {
