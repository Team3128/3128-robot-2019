...
/**
 * Motor control logic that tries to hold the motor at a certain current. It
 * uses P only, and needs an estimate of how much current the motor uses at full
 * power.
 * 
 * @author Jamie
 *
...
public class ConstantCurrentLogic extends MotorLogic {
     ...
     */
    public ConstantCurrentLogic(PowerDistributionPanel panel, int motorPort, PIDConstants pidConstants,
            double feedForward) {
        this.panel = panel;
