...
public class CmdApproachPerpendicular extends Command {
    ...
    public CmdApproachPerpendicular(
            Limelight limelight, DriveCommandRunning cmdRunning, double targetHeight,
    ...
    protected void execute() {
        switch (aimState) {
            ...
            case APPROACHING_PERPENDICULAR:
                ...
                if (currentError <= 0) {
                    /**
                     * PID feedback loop for the left and right powers based on the error in the wall intersect distance.
                     */
                    feedbackPower = 0;
                    ...
                    rightPower = RobotMath.clamp(approachPID.kF + (side == Direction.RIGHT ? 1 : -1) *feedbackPower, -1, 1);
