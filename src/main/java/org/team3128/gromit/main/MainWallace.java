...
public class MainWallace extends MainDeepSpaceRobot {
    ...
    /*
     * @Override protected void setupListeners() { // REGULAR CONTROLS
     * //super.setupListeners(); // Drive
     * listenerRight.nameControl(ControllerExtreme3D.JOYY, "MoveForwards");
     * listenerRight.nameControl(ControllerExtreme3D.TWIST, "MoveTurn");
     * listenerRight.nameControl(ControllerExtreme3D.THROTTLE, "Throttle");
     * 
     * listenerRight.addMultiListener(() -> { if (!runningCommand) { double vert =
     * -1.0 * listenerRight.getAxis("MoveForwards"); //DEBUG: IF ANYTHING GOES
     * WRONG, CHANGE TO -0.8 (ADHAM AND JUDE REMEMBER) double horiz = -0.8 *
     * listenerRight.getAxis("MoveTurn"); double throttle = -1.0 *
     * listenerRight.getAxis("Throttle");
     * 
     * drive.arcadeDrive(vert, horiz, throttle, true); //Log.info("Joystick",
     * "IT WORKS"); } }, "MoveForwards", "MoveTurn", "Throttle");
     * 
     ...
     * 
     * listenerLeft.addMultiListener(() -> { if
     * (listenerLeft.getButton("ManualMode")) { lift.override = false;
     * lift.powerControl(0);
     * 
     * fourBar.override = listenerLeft.getButton("Override");
     * fourBar.powerControl(listenerLeft.getAxis("ManualControl")); } else {
     * fourBar.override = false; fourBar.powerControl(0);
     * 
     * lift.override = listenerLeft.getButton("Override");
     * lift.powerControl(listenerLeft.getAxis("ManualControl")); } }, "ManualMode",
     * "Override", "ManualControl"); listenerLeft.nameControl(new Button(11),
     * "CheckLimitSwitch"); listenerLeft.addButtonDownListener("CheckLimitSwitch",
