...
public class SRXDrive extends Threaded {
    ...
    private static final SRXDrive instance = new SRXDrive();

    public static SRXDrive getInstance() {
        return instance;
    }
    ...
    public LazyTalonSRX leftTalon, rightTalon, leftTalonSlave, rightTalonSlave, leftSparkSlave2, rightSparkSlave2;

    private SRXDrive() {

        gyroSensor = new ADXRS450_Gyro(SPI.Port.kOnboardCS0);

        leftTalon = new LazyTalonSRX(Constants.LEFT_DRIVE_FRONT_ID);
        leftTalonSlave = new LazyTalonSRX(Constants.LEFT_DRIVE_MIDDLE_ID);
        // leftTalonSlave2 = new LazyTalonSRX(Constants.LEFT_DRIVE_BACK_ID);

        rightTalon = new LazyTalonSRX(Constants.RIGHT_DRIVE_FRONT_ID);
        rightTalonSlave = new LazyTalonSRX(Constants.RIGHT_DRIVE_MIDDLE_ID);
        // rightTalonSlave2 = new LazyCANSparkMax(Constants.RIGHT_DRIVE_BACK_ID);
    ...
    private void configAuto() {
        ...
        rightTalon.config_kD(0, Constants.K_AUTO_RIGHT_P);
        rightTalon.config_kF(0, Constants.K_AUTO_RIGHT_P);

        leftTalon.config_kP(0, Constants.K_AUTO_RIGHT_P);
        leftTalon.config_kD(0, Constants.K_AUTO_RIGHT_P);
        leftTalon.config_kF(0, Constants.K_AUTO_RIGHT_P);
    ...
    public double getLeftDistance() {
         ...
         * 62d / 3d;
         */
        return leftSparkEncoder.getSelectedSensorPosition() * Constants.WHEEL_DIAMETER * Math.PI
    ...
    private void setWheelPower(DriveSignal setVelocity) {
        leftTalon.set(ControlMode.PercentOutput, setVelocity.leftVelocity);
        rightTalon.set(ControlMode.PercentOutput, setVelocity.rightVelocity);
    }
